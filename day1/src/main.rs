...
const CALIBRATION_LINES: [&str; 1000] = [
    "8eight1",
    "98126",
...
pub fn sum_values() -> u32 {
    CALIBRATION_LINES.map(get_calibration_value).iter().sum()
}
...
fn main() {
    println!("Sum of all calibration values: {}", sum_values());
}
